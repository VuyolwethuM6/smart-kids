          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
              >
                <Card className="h-full bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-t-theme-darkBlue">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-white shadow-xl">
                  ...
                  <div className="relative h-[400px] overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 z-20 transform translate-y-2 transition-transform duration-500 group-hover:translate-y-0">
                      ...
                      <p className="text-theme-gold font-medium text-lg">
                        {member.role}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-center gap-4 mt-4">
                      <a href="#" className="text-gray-400 hover:text-theme-gold transition-colors">
            ...
            >
              ...
              <div className="md:w-1/2">
                ...
                <div>
                  ...
                  <p className="text-theme-gold text-lg">Principal & Founder</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-12 opacity-90">
              Start your journey with Smart Kids X Academy today.
            </p>
            <Button 
              size="lg" 
              className="bg-white text-theme-darkBlue hover:bg-theme-lightBlue text-lg px-12 py-6"
            >
              Enroll Now
            </Button>
          </motion.div>
